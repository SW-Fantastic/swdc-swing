package org.swdc.xswing.font;

import org.swdc.xswing.SwingApplication;
...
public class Fontawsome5Service {
    ...
    private Font fontsFreeRegular = null;
    private Font fontsSolid = null;
    private Font fontsBrand = null;
    ...
    public Fontawsome5Service() {
        try {
            ...
            Module module = SwingApplication.class.getModule();

            this.fontsSolid = Font.createFont(Font.TRUETYPE_FONT,module.getResourceAsStream(location[0]));
            this.fontsFreeRegular =  Font.createFont(Font.TRUETYPE_FONT,module.getResourceAsStream(location[1]));
            this.fontsBrand =  Font.createFont(Font.TRUETYPE_FONT,module.getResourceAsStream(location[2]));
    ...
    public Font getFontsFreeRegular() {
        return fontsFreeRegular;
    }

    public Font getFontsBrand() {
        return fontsBrand;
    }

    public Font getFontsSolid() {
        return fontsSolid;
    }
